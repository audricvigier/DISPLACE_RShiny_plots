...
barplotTotLandingsPerSce (general=general,
                                   type_of_column="pop",
                                    ...
                                    scenarios_names=c("Size Spec. Baseline", 
                                       " - Predation", 
                                     #  " - Predation + Avoiding choke spp.",
                                       "+ Avoid",
                                      # "+ Stop if choked",
                                       "+ Avoid + Stop if choked",
                                       "+ Avoid High Tariffs",
                                       "+ Focus on High Tariffs"
                                    ),
                                    nby=5, firsty="2015", lasty="2019",
                                    a_width=3500, a_height=2000, black_and_white = FALSE, ylims = c(0,60))  # ylims in thousands tons
